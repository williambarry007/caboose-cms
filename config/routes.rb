Caboose::Engine.routes.draw do
  ...
  get     "admin/pages/:id/redirect"        => "pages#admin_redirect"
  get     "admin/pages/:id/edit-settings"   => "pages#admin_edit_settings"
  get     "admin/pages/:id/edit-css"        => "pages#admin_edit_css"
  get     "admin/pages/:id/edit-js"         => "pages#admin_edit_js"
  get     "admin/pages/:id/edit-seo"        => "pages#admin_edit_seo"
  get     "admin/pages/:id/edit-resources"  => "pages#admin_edit_resources"
  get     "admin/pages/:id/edit-content"    => "pages#admin_edit_content"
