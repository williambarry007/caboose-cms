Caboose::Engine.routes.draw do
  ...
  get  '/checkout/state-options'              => 'checkout#state_options'
  get  '/checkout/json'                       => 'checkout#order_json'    
  ...
  put  '/checkout/billing-address'            => 'checkout#update_billing_address'
  put  '/checkout/shipping-address'           => 'checkout#update_shipping_address'
  get  '/checkout/shipping/json'              => 'checkout#shipping_json'
  ...
  put  '/checkout/stripe-details'             => 'checkout#update_stripe_details'
