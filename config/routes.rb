Caboose::Engine.routes.draw do
  ...
  put     "admin/fields/:id"                       => "fields#admin_update"
  post    "admin/fields/:id/image"                 => "fields#admin_update_image"
  post    "admin/fields/:id/file"                  => "fields#admin_update_file"
  ...
  get     "admin/field-types/field-type-options"                  => "field_types#admin_field_type_options"
  get     "admin/field-types/:id/options"                         => "field_types#admin_options"
  get     "admin/block-types/:block_type_id/field-types/new"      => "field_types#admin_new"    
  get     "admin/block-types/:block_type_id/field-types/:id/edit" => "field_types#admin_edit"
  get     "admin/block-types/:block_type_id/field-types/:id"      => "field_types#admin_index"
  post    "admin/block-types/:block_type_id/field-types"          => "field_types#admin_create"  
  put     "admin/block-types/:block_type_id/field-types/:id"      => "field_types#admin_update"
  delete  "admin/block-types/:block_type_id/field-types/:id"      => "field_types#admin_delete"
